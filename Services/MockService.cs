...
public class MockService
{
    ...
    private static readonly List<MockRecipeData> MockRecipes = new()
    {
        ...
        new MockRecipeData { Id = 9, Name = "Luckin Coffee", Category = "Beverages", Rating = 4.5, Description = "Popular Chinese coffee chain with various flavors.", Calories = 180, PrepTime = 5, Ingredients = "Coffee beans, Milk, Syrup, Ice", Instructions = "1. Brew coffee. 2. Add milk and syrup. 3. Serve with ice.", ImageName = "luckin_coffee.jpg" }
    };
